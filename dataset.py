...
class Dataset(Dataset):
    ...
    def _extract_label_mapping(self, split_path="/content/drive/My Drive/eaction/data/ucfTrainTestlist"):
    ...
    def _extract_sequence_paths(
        self, dataset_path, split_path="/content/drive/My Drive/eaction/data/ucfTrainTestlist", split_number=1, training=True
    ):
